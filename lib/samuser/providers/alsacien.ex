defmodule Samuser.Providers.Alsacien do
  @moduledoc """
  Provider pour le Musée Alsacien.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-alsacien"

  @impl true
  def museum_info do
    %{name: "Musee Alsacien", url: @page_url, provider: :alsacien}
  end
