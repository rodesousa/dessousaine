defmodule Samuser.Providers.Archeologique do
  @moduledoc """
  Provider pour le Musée Archéologique.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-archeologique"

  @impl true
  def museum_info do
    %{name: "Musee Archeologique", url: @page_url, provider: :archeologique}
  end
