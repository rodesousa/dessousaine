defmodule Samuser.Providers.ArtModerne do
  @moduledoc """
  Provider pour le Musée d'Art moderne et contemporain.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-d-art-moderne-et-contemporain"

  @impl true
  def museum_info do
    %{name: "Musee d'Art moderne et contemporain", url: @page_url, provider: :art_moderne}
  end
