defmodule Samuser.Providers.ArtsDecoratifs do
  @moduledoc """
  Provider pour le Musée des Arts Décoratifs.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-des-arts-decoratifs"

  @impl true
  def museum_info do
    %{name: "Musee des Arts Decoratifs", url: @page_url, provider: :arts_decoratifs}
  end
