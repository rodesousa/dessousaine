defmodule Samuser.Providers.Historique do
  @moduledoc """
  Provider pour le Musée Historique.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-historique"

  @impl true
  def museum_info do
    %{name: "Musee Historique", url: @page_url, provider: :historique}
  end
