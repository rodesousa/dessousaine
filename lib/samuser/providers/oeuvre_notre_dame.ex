defmodule Samuser.Providers.OeuvreNotreDame do
  @moduledoc """
  Provider pour le Musée de l'Œuvre Notre-Dame.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-de-l-oeuvre-notre-dame"

  @impl true
  def museum_info do
    %{name: "Musee de l'Oeuvre Notre-Dame", url: @page_url, provider: :oeuvre_notre_dame}
  end
