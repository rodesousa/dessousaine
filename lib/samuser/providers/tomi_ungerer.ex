defmodule Samuser.Providers.TomiUngerer do
  @moduledoc """
  Provider pour le Musée Tomi Ungerer - Centre international de l'Illustration.
  """

  @behaviour Samuser.Providers.Provider

  @base_url "https://www.musees.strasbourg.eu"
  @page_url "#{@base_url}/web/musees/musee-tomi-ungerer"

  @impl true
  def museum_info do
    %{name: "Musee Tomi Ungerer", url: @page_url, provider: :tomi_ungerer}
  end
